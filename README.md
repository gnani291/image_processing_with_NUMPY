This project demonstrates fundamental image processing operations using NumPy by treating digital images as numerical arrays. The uploaded image is converted into a matrix format, allowing mathematical operations to be applied directly on pixel values.
